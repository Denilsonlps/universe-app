...
class BenefitsGovScreen extends StatelessWidget {
  const BenefitsGovScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final benefits = MockRepository.benefits.where((b) => b.kind == BenefitKind.gov).toList();
      ...
      body: Column(
        children: [
          const GreenHeroHeader(
            title: 'Benefícios Governamentais',
            subtitle: 'Programas de apoio ao estudante',
          ...
          Expanded(
            child: ListView(
              ...
              children: benefits.map((b) => Padding(
                    ...
                    child: AppCard(
                      onTap: () => context.go('/benefits/gov/${b.id}'),
                      child: Row(
                        children: [
                          Container(
                            width: 44,
                            ...
                            child: const Icon(Icons.card_giftcard_rounded, color: AppColors.green700, size: 22),
                          ),
