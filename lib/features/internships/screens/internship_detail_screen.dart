...
class InternshipDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final item = MockRepository.internships.firstWhere(
      (i) => i.id == internshipId,
      orElse: () => MockRepository.internships.first,
    );
            ...
            child: ListView(
              ...
              children: [
                AppCard(
                  child: Column(
                    children: [
                      _InfoRow(Icons.attach_money_rounded, 'Bolsa', item.stipendFormatted),
                      const Divider(height: 20),
                      _InfoRow(Icons.location_on_outlined, 'Modalidade', item.modality.label),
                      const Divider(height: 20),
                      _InfoRow(Icons.school_outlined, 'Curso alvo', item.targetCourse),
                      const Divider(height: 20),
                      Row(
                        children: [
                  ...
                  AppCard(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 8),
                        Text(item.requirements!, style: Theme.of(context).textTheme.bodyMedium),
                      ],
                    ),
                  ),
                ],
